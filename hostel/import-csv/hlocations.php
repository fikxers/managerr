...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            $location = "";
            if (isset($column[0])) {
                $location = mysqli_real_escape_string($conn, $column[0]);
            }
            //https://www.w3schools.com/php/php_mysql_prepared_statements.asp
            $sqlInsert = "INSERT into hostel_locations (location,hostel)
                   values (?,?)";
            $paramType = "ss"; 
            $paramArray = array(
                $location,
...
<body>
    <h2>Import Locations CSV file</h2>
    <div id="response"
