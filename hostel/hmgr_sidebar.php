<?php 
  require('../db.php'); //include "check_token.php";
                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="add_resident.php">Register Resident</a></li>  
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                              ...
                              <li><a href="fikxer_skills.php">Fikxer Skills</a></li>
                            </ul>
                        </li>
                        <li> <?php $link = "update-password.php?id=".$_SESSION['email']."&op=2"; ?>
                            <a href="<?php echo $link; ?>" class="waves-effect">
