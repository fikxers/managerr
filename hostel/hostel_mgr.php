<?php require('auth.php'); $title ='Dashboard'; 
      if($_SESSION['admin_type']=='hmgr') {
      	...
      	$sql = "SELECT * FROM student_requests where status='Pending' and hostel = '".$_SESSION['hostel']."'";
      } 
              ...
              <div class="card-body">
                ...
                <div class="table-rep-plugin">
                  ...
                  <?php 
                        ...
                        <thead>
                          <tr class="titles">
                          	<th>Service</th><th>Equipment</th><th>Service Date</th><th>Info</th><th>Room</th><th>Fikxer</th><th>Action</th>
                        ...
                        <tbody> <?php
                          ...
                          <td><?php echo $row['fikxer']; ?></td>
							           <?php 
                          echo "<td><a href='hostel-update.php?id=" . $row['id'] . "&op=1' data-toggle='tooltip' data-original-title='Assign Fikxer'><i class='fa fa-pencil text-info m-r-10'></i></a>"."<a href='hostel-update.php?id=" . $row['id'] . "&op=3' data-toggle='tooltip' data-original-title='Delete'><i class='fa fa-trash text-danger m-r-10'></i></a></td>";
                          //<a href='hostel-update.php?id=" . $row['id'] . "&op=2' data-toggle='tooltip' data-original-title='Complete Job'><i class='fa fa-check-square text-success m-r-10'></i></a>
                          ?>
