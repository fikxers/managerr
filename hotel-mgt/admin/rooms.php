...
<html lang="en">
<?php session_start();  
  $title = 'Room Management'; require('../db.php'); require('../functions.php');
  if (isset($_POST['task'])){
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                if($row['Status'] == 'Occupied'){
                                                    echo '<a type="button" class="btn btn-primary btn-sm" style="background-color: transparent; border-width: 0px;" href="view_booking.php?room_number='.$row['room_number'].'&room_id='.$row['room_id'].'&hotel_id='.$row['hotel_id'].'"><i class="fas fa-file-signature text-primary"> View Booking</i></button></a>';
                                                }
                                                else{
                                                    echo '<a type="button" class="btn btn-success btn-sm" style="background-color: transparent; border-width: 0px;" href="book_room.php?room_number='.$row['room_number'].'&hotel_id='.$row['hotel_id'].'"><i class="fas fa-book text-success"> Book</i></button></a>';
                                                }
                                                echo '</td>';
                                                $j++;
                                                ?>
