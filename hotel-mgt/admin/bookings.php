...
<?php
  session_start();  
  $title = 'All Bookings';require('../db.php'); require('../functions.php');
  if (isset($_POST['task'])){
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <?php $j=1;  
                                $sql = "SELECT *,CONCAT(g.FirstName, ' ', g.LastName) AS fullname,h.Name hotel_name FROM `booking` b JOIN guest g using (guest_id) JOIN hotel h on h.hotel_id=b.hotel_id JOIN room r on r.room_id=b.room_id"; $result = $con->query($sql);
                                if ($result->num_rows > 0) { ?>
                            <table width="100%" class="table table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>S/No</th><th>Name</th>
                                        <th>Room</th><th>Hotel</th><th>Checkin</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['total_price']; $j++; ?></td>
                                        <td class="text-end">
