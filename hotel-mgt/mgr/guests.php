    ...
    if($task == 'add' || $task == 'edit'){
      switch ($task) {
        case "add":
          ...
          $email = stripslashes($_REQUEST['email']); $phone = stripslashes($_REQUEST['phone']); 
          $query = "INSERT INTO `guest`(`FirstName`, `LastName`, `dob`, `Address`, `Phone`, `Email`, `hotel_id`) VALUES ('".$fname."','".$lname."','".$dob."','".$address."','".$phone."','".$email."',".$_SESSION['hotel'].")";
                ...
                <div class="container">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            $sql = "SELECT * FROM guest where hotel_id=".$_SESSION['hotel']; 
                            $result = $con->query($sql);
                            if ($result->num_rows > 0) { ?>
