...
<html lang="en">
<?php
  session_start();  $title = 'Dashboard';
  require('../functions.php'); hotel_login(); require('../db.php');
  $query = "SELECT hotel_id,name FROM `staff` WHERE email='".$_SESSION['email']."'";
  $result = mysqli_query($con,$query) or die(mysql_error());
  $_SESSION['hotel'] = $result->fetch_object()->hotel_id;
  $result = mysqli_query($con,$query) or die(mysql_error());
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="teal fas fa-hotel"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Hotels</p>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="olive fas fa-user-tie"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Managers</p>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Rooms</p>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Guests</p>
