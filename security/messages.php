...
$_SESSION['show']= 0; $v=""; $code=""; $comp=0; $regno="";
		...
		$estate_code = $_SESSION['estate'];
		  if (isset($_POST['send_msg'])){
				...
				$query = "INSERT into `messages` (sender,receiver,subject, message, date_received) VALUES ('".$_SESSION['email']."','$flat','$subject', '$message', '$trn_date')";
		  ...
		  elseif (isset($_POST['reply'])){
				...
				$trn_date = date("Y-m-d H:i:s");
				$query = "INSERT into `messages` (sender,receiver,subject, message, date_received,replied_to) VALUES ('".$_SESSION['email']."','".$flat."','$subject', '$message', '$trn_date',$reply_to)";
				$result = mysqli_query($con,$query);
				if($result){
		...
		?>
          <div class="row">
                ...
                <div class="card-body">
							  ...
							  <button type='button' class='btn btn-danger btn-sm' style='border-radius: 10px; float: right;' data-toggle='modal' data-target='#chatmodal' data-original-title='Complaint'><b>Contact Resident</b></button><br><br>
							  <!-- Modal -->
