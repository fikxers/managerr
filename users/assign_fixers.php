             ...
             <div class="table-rep-plugin">
              <div class="table-responsive b-0" data-pattern="priority-columns">
                <?php include ('../db.php');
                    ...
                    <thead>
                    <tr>
                    	<th>Name</th><th>Email</th><th>Phone</th><th>Skill</th>
											<th>Skill 2</th><th>Skill 3</th><th>Status</th>
                    ...
                    <tbody> 
                   	<?php  while($row = $result->fetch_assoc()) { ?>
										<tr>
											...
											<td contenteditable="true"><?php echo $row['skill2']; ?></td>
											<td contenteditable="true"><?php echo $row['skill3']; ?></td>
            ...
            <div class="card-body">
              ...
              <div class="table-rep-plugin">
                <div class="table-responsive b-0" data-pattern="priority-columns">
                    ...
                    <thead>
                      <tr>
                        <th>Flat</th><th>Block</th> <th>Equipment</th>
												<th>Problem</th><th>Commencement Date</th>
												<th>Description</th><th>Skill Required</th> 
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-rep-plugin">
                        <div class="table-responsive b-0" data-pattern="priority-columns">
                          ...
                          <thead>
                            <tr>
                              <th>Flat No</th> <th>Block No</th><th>Service</th> <th>Info</th>
															<th>Commencement Date</th><th>Description</th><th>Skill Required</th>
                            </tr>
                          </thead>
                          <tbody>
												  <?php include ('db.php');
