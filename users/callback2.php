...
if (array_key_exists('data', $result) && array_key_exists('status', $result['data']) && ($result['data']['status'] === 'success')) {
  echo '<div class="alert alert-success" role="alert">Payment was successful! We will contact you shortly.</div>';
	...
	//STEP 1
	$insertOrder = "INSERT INTO `orders`(`user_name`, `user_phone`,`user_id`, `order_date`, `price`, `location`, `payment_type`, `order_status`) VALUES ('$user_name','$user_phone',$user_id,'$trn_date',$price,'$address','online','successful')";
	...
	//STEP 3
	$insertPayment = "INSERT INTO `payment`(`order_id`, `payment_status`, `payment_response`, `created_at`) VALUES ($current_order,'pending','pending','$trn_date')";
