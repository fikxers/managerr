        ...
        <div class="left side-menu">
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div class="user-details">
                    ...
                    <div class="user-info">
                        <h4 class="font-16 text-white"><?php echo "Flat ".$_SESSION['flat_no']." - Block ".$_SESSION['block_no']; ?></h4> <h6 class="font-14 text-warning"><?php echo $_SESSION['owner']; ?></h6>
                        <span class="text-white"><i class="fa fa-dot-circle-o text-success"></i> Online</span><br>
						<span class="counter text-white">Status: </span>
						<?php if($duestatus=='good'){echo '<span class="badge badge-success">'.$duestatus.'</span>';} 
