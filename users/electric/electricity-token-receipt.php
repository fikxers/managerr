...
$meterPAN=$_SESSION['meterPAN']; $customerName=$_SESSION['customerName']; 

$description=$_SESSION['description']; 

$value=$_SESSION['value'];$tariff=$_SESSION['tariff']; 

$formatted_token=$_SESSION['token']; $unitsActual=$_SESSION['unitsActual']; 

$unitName=$_SESSION['unitName']; $generated_by=$_SESSION['generated_by']; 

$transactionDate=$_SESSION['transactionDate']; 

$transactionId=$_SESSION['transactionId']; $estate=$_SESSION['estate_name'];
...
<html lang="en">
  ...
  <body>
    ...
    <div id="receipt">
      ...
      <h4>Powered by <a href="https://HAIVEN.net">HAIVEN</a>  </h4> -->
