...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            $service_name = "";
            if (isset($column[0])) {
                $service_name = mysqli_real_escape_string($conn, $column[0]);
            }
            //https://www.w3schools.com/php/php_mysql_prepared_statements.asp
            $sqlInsert = "INSERT into hostelservices (service_name,hostel)
                   values (?,?)";
            $paramType = "ss"; 
            $paramArray = array(
                $service_name,
...
<body>
    <h2>Import Services CSV file</h2>
    <div id="response"
