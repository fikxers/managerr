<?php require('auth.php'); $title ='Hotel Managers'; 
	  require('../db.php');
	  //Add Hostel Manager
		...
		<div class="row">       
		  <div class="col-lg-12">
	        <div class="card m-b-30">
	          <div class="card-body">
	            <h4 class="mt-0 header-title">All Hotel Managers</h4>
		        	<div class="table-rep-plugin">
		          <div class="table-responsive b-0" data-pattern="priority-columns">
		          	<?php include ('../db.php');
								$sql = "SELECT * FROM hotel_manager JOIN hotels on hotel_manager.hotel=hotels.hotel_code";
								$result = $con->query($sql);
								if ($result->num_rows > 0) { ?>
								<table id="tech-companies-1" class="table table-bordered table-striped">
		              <thead><tr class="titles"><th>Name</th><th>Phone</th><th>Hotel</th><th>Action</th></tr></thead>
                    ...
                    <!-- Delete Modal -->
										<?php } 
								    } else { echo "No hotel manager in database.";}
									$con->close(); ?>                                  
					  			</tbody>
		            </table>
		          </div>
