        ...
        <div class="left side-menu">
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div class="user-details">
                    ...
                    <div class="user-info">
                        <h4 class="font-16 text-white"><?php echo "Room ".$_SESSION['room']; ?></h4> <h6 class="font-14 text-warning"><?php echo $_SESSION['name']; ?></h6>
            ...
            <div id="sidebar-menu">
                <ul>
                        ...
                        <li>
                            <a href="hostelequipments.php" class="waves-effect"><i class="ti-calendar"></i><span> Equipments </span></a>
                        </li>
						<!--<li>
