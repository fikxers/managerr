<?php include('auth.php'); $title ='Errand Services'; ?>
        <?php 
          ...
          <div class="container-fluid">
		    <div class="row">       
					...
					if($_SESSION['admin_type']=='admin'){$sql = "SELECT * FROM orders where order_type='home_service'";}
						...
						<table id="tech-companies-1" class="table  table-striped">
                          <thead><tr class="titles"><th>Name of Service</th>
							<th>Description</th><th>Preferred Date</th><th>Status</th></tr></thead>
                          <tbody> <?php while($row = $result->fetch_assoc()) { ?>
							...
							<?php } } else { echo "No home service yet.";} 
							$con->close(); ?>    </tbody>
                        </table>
                    </div>
				  </div>
			  ...
			  <div class="col-lg-12">
                <div class="card m-b-30">
                  <div class="card-body">
                  <h4 class="mt-0 header-title">Request Errand Service</h4>
