<?php 
  require('../db.php');
  $query = "SELECT * FROM `hotel_manager` WHERE email='".$_SESSION['email']."'";
  $query2 = "SELECT * FROM `hotels` WHERE hotel_code='".$_SESSION['hotel']."'";
  $result = mysqli_query($con,$query) or die(mysql_error());
  $rows = mysqli_num_rows($result);
  $_SESSION['hotel'] = $result->fetch_object()->hotel;
  $result = mysqli_query($con,$query) or die(mysql_error());
  $_SESSION['name'] = $result->fetch_object()->manager_name;
  $result = mysqli_query($con,$query2) or die(mysql_error());
  $_SESSION['hotel_name'] = $result->fetch_object()->hotel_name;
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title><?php echo $_SESSION['hotel']; ?> - Hotel Manager</title>
        ...
        <div class="left side-menu">
            ...
            <div class="sidebar-inner slimscrollleft">
                <div class="user-details">
                    ...
                    <div class="user-info">
                            <h4 class="font-16 text-white"><?php echo "Hotel: ".$_SESSION['hotel_name'];//$_SESSION['email']; ?></h4> <h6 class="font-14 text-warning"><?php echo $_SESSION['name']; ?></h6>
            ...
            <div id="sidebar-menu">
                <ul>
                        <li>
                            <a href="hotel_mgr.php" class="waves-effect">
                              <i class="ti-home"></i><span> Home</span>
                            </a>
                        </li>
                        <li>
                            <!-- <a href="hotel_room.php?" class="waves-effect">
                                <i class="fa fa-building"></i>
                                <span> Rooms</span>
                            </a> -->
                            <?php echo "<a href='hotel_room.php?hotel_code=" .$_SESSION['hotel']."&hotel_name=" .$_SESSION['hotel_name']."' data-toggle='tooltip' data-original-title='View Rooms'><i class='fa fa-building'></i><span> Rooms</span></a>"; ?>
                        </li>
                    </ul>
                </div>
