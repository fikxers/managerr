        ...
        <div class="left side-menu">
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div class="user-details">
                    ...
                    <div class="user-info">
                            <h4 class="font-16 text-white"><?php echo "Hostel: ".$_SESSION['hostel'];//$_SESSION['email']; ?></h4> <h6 class="font-14 text-warning"><?php echo $_SESSION['name']; ?></h6>
            ...
            <div id="sidebar-menu">
                <ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-table"></i> <span> Management  </span> <span class="pull-right"><i class="mdi mdi-chevron-right"></i></span></a>
                            <ul class="list-unstyled"> 
