...
<?php
  ...
  $sql = "SELECT * FROM estate_manager WHERE email = '$id'";
  ...
  if (isset($_POST['update'])){
	...
	$query = "UPDATE estate_manager set name='".$mname."',phone='".$phone."' WHERE email = '$id'";
  ...
  { ?>
	<form class="" action="" method="POST">
		<div class="form-group">
          <input type="text" name="mname" class="form-control" placeholder="<?php echo "Name of Manager"; ?>"/>
        </div>		
		<div class="form-group">
          <input type="text" name="phone" class="form-control" placeholder="<?php echo "Manager's Phone"; ?>"/>
        </div>
        <div class="form-group">
          <div>
