                  ...
                  <?php include ('../db.php');
					...
					if ($result->num_rows > 0) { ?>
					  <table id="tech-companies-1" class="table editable-table table-bordered table-striped m-b-0">
                        <thead>
                          <tr class="titles">
                          	<th>Service</th><th>Equipment</th><th>Service Date</th><th>Info</th><th>Room</th><th>Status</th><th>Action</th>
							<?php if($_SESSION['admin_type']=='admin'){echo 'Estate';} ?>
                          </tr>
                        </thead>
                        <tbody> <?php
						while($row = $result->fetch_assoc()) { ?>
						<tr><td contenteditable="true"><?php echo $row['service']; ?></td>
              <td contenteditable="true"><?php echo $row['equipment']; ?></td>
              <td contenteditable="true"><?php echo $row['service_date']; ?></td>
              <td contenteditable="true"><?php echo $row['info']; ?></td>
              <td contenteditable><?php echo $row['room']; ?></td>
