<?php require('auth.php'); $title ='Fikxers'; ?>
	...
	<?php
	  ...
	  else if($password != $password2)
	  {
	    ...
	    $query = "INSERT into `hostel_fikxers` (name, skill,skill2,skill3,status, phone, email, home_address, hostel, created_at) VALUES ('$fixer_name', '$skill','$skill2','$skill3','$status', '$phone', '$email', '$address', '$hostel', '$trn_date')";
													...
													<table id="tech-companies-1" class="table  table-striped">
                                                      <thead>
                                                        <tr class="titles">
                                                            ...
                                                            <th>Phone</th>
                                                            <th>Status</th>         
															<?php if($_SESSION['admin_type']=='admin'){echo "<th>Hostel</th>";} ?>  <th>Action</th>
                                                        </tr>
                                                      </thead>
													  <tbody> <?php
														while($row = $result->fetch_assoc()) { 
															...
															echo "<td><a href='update_fixer.php?id=" .$row['email']."&phone=" .$row['phone']."' data-toggle='tooltip' data-original-title='Update'><i class='fa fa-pencil text-success m-r-10'></i></a> <a href='delete_fixer.php?id=" . $row['email'] . "' data-toggle='tooltip' data-original-title='Delete'><i class='fa fa-trash text-danger m-r-10'></i></a> </td>";
															echo "</tr>";														
														}
													} else {
