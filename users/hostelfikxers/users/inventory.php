            ...
            <div class="card m-b-30">
              <div class="card-body">
                ...
                <form class="" action="" method="POST">
                  <div class="row">
                  	<div class="col-md-4 form-group"><input type="text" name="mat" class="form-control" required placeholder="Material"/></div>
                  ...
                  <?php include ('../db.php');
					...
					if ($result->num_rows > 0) { ?>
					  <table id="tech-companies-1" class="table editable-table table-bordered table-striped m-b-0">
                        <thead>
                          <tr class="titles">
                          	<th>Material</th><th>Quantity</th><th>Action</th>
							<?php if($_SESSION['admin_type']=='admin'){echo 'Estate';} ?>
                          </tr>
                        </thead>
                        <tbody> <?php
						while($row = $result->fetch_assoc()) { ?>
						<tr><td contenteditable="true"><?php echo $row['part']; ?></td>
							<td contenteditable><?php echo $row['qty']; ?></td>
