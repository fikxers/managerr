													...
													<table id="tech-companies-1" class="table  table-striped">
                                                      ...
                                                      <tbody> <?php
														while($row = $result->fetch_assoc()) { ?>
															...
															<?php
															echo "<td><a href='update_mgr.php?id=" .$row['email']."&phone=" .$row['phone']."&name=" .$row['name']."' data-toggle='tooltip' data-original-title='Update'><i class='fa fa-pencil text-success m-r-10'></i></a> </td>";
															echo "<td><a href='delete_mgr.php?id=" . $row['email'] . "' data-toggle='tooltip' data-original-title='Delete'><i class='fa fa-trash text-danger m-r-10'></i></a> </td>";
															echo "</tr>";
															?>
															</tr>
														<?php
														...
														echo "No estate manager in database.";
													}
													$con->close();
													?>                                                       
                                                        </tbody>
                                        ...
                                        <p class="text-muted m-b-30 font-14">Enter details of a new estate manager.</p>
                                          <form class="" action="" method="POST">
                                            <div class="form-group">
                                              <input type="text" name="mgr_name" class="form-control" required placeholder="Name of Estate Manager"/>
                                            </div>
                                            <!--<div class="form-group">
