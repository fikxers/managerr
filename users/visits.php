<?php require('auth.php'); $title ='Visits'; 
		...
		<div class="row">
          ...
          <div class="card-body">
              ...
              <div class="table-responsive b-0" data-pattern="priority-columns">
                ...
                <?php include ('../db.php');
								$sql = "SELECT * FROM entrance_codes where estate='".$_SESSION['estate']."' and (status='signed-in' OR status='signed-out') and block='0' and flat='0'";
                  ...
                  <tbody> <?php $i=1; while($row = $result->fetch_assoc()) { 
                  	...
                  	?>
									...
									<td><?php echo $row['duration']." hours"; ?></td><td><?php echo $myFormatForView; ?></td>
