                    ...
                    <nav class="custom-nav">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                ...
                                <form class="col-lg-12 forgot-pass">
                                    <div class="row">
                                        <div class="col-lg-6">
                            ...
                            <div class="tab-pane fade" id="pills-password" role="tabpanel" aria-labelledby="pills-password">
                                ...
                                <form class="col-lg-12">
                                    <div class="row forgot-pass">
                                        <div class="col-lg-6">
                                            <input type="text" disabled class="form-control form-control-custom" value="koryoesz@gmail.com"  placeholder="email">
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" disabled value="+2348109074894" class="form-control form-control-custom" placeholder="Phone Number">
                                        </div>
                                    </div>
                                    <div class="row mb-3 pad-33 forgot-pass">
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control form-control-custom" placeholder="Create Password">
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control form-control-custom" placeholder="Repeat Password">
                                        </div>
                                    </div>
                                </form>
                                <div class="col-lg-12">
