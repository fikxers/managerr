	...
	<?php $title='Recover Password'; include('header.php'); 
	  ...
	  if (isset($_POST['email'])){
		...
		$link = "https://HAIVEN.net/reset-password.php?key='.$token.'&email='.$email.'&action=reset";
		...
		$output.='<p><a href="https://HAIVEN.net/reset-password.php?key='.$token.'&email='.$email_to.'&action=reset" target="_blank">https://HAIVEN.net/reset-password.php?key='.$token.'&email='.$email_to.'&action=reset</a></p>';		
		...
		$subject = "Password Recovery - HAIVEN.net";

		$fromserver = "support@HAIVEN.net"; 
