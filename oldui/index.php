	<?php $title='Home'; include('header.php'); //include_once('redirect_if_logged_in.php'); ?>
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center">
						<div class="banner-content col-lg-7 col-md-6 justify-content-center ">
							<!--<h6 class="text-uppercase">Get Quality Services, for less</h6>-->
							<h1>
			...
			<section class="discount-section-area relative">
				<div class="overlay overlay-bg"></div><br>
				<div class="container">
						...
						<div class="row text-white">
							<div class="col-lg-4">
								<ol class="unordered-list">
									<li><span>Best practices for creating, receiving, and dispatching service requests</span></li>
									<li><span>Additional Level of Estate security as it prevents access to handymen and service providers who may not be traceable</span></li>
									<li><span>It provides a competitive task/job bidding platform by service providers while preventing price hike</span></li></li>
								</ol>
							</div>
							<div class="col-lg-4">
								<ul class="unordered-list">
									<li><span>It ensures quality of workmanship and accountability should something go wrong</span></li>
									<li><span>It promotes professionalism and good customer care service</span></li>
									<li><span>It provides a central management platform for tracking jobs and repair history</span></li>
									<li><span>It serves as a good system of record for Estates and Facilities</span></li>
								</ul>
							</div>
							<div class="col-lg-4">
								<ul class="unordered-list">
									<li><span>It supports encourages good maintenance culture and behavior</span></li>
									<li><span>It serves as a seamless levy / tenancy / dues / fee collection and tracking platforms with ease of reporting</span></li>
									<li><span>It ensures reliability of common systems like water supply, power drainage etc.</span></li><li><span>It promotes transparency</span></li>
								</ul>
							</div>
						</div>
						<br>
			...
			<section class="work-process-area pt-40">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-5 col-lg-7">
							<div class="title text-center">
								<h1 class="mb-10">How it Works</h1>
								<p>Check out our simple 3-step process</p>
							</div>
						</div>
					</div>	
					<div class="total-work-process d-flex flex-wrap justify-content-around align-items-center">
						<div class="single-work-process">
							...
							<h4 class="caption">Generate a service request</h4>from flat/room/department
						</div>
						...
						<div class="single-work-process">
							...
							<h4 class="caption">Review quotes </h4>from service providers & select preferred quote
						</div>
						<div class="work-arrow">
							<img src="img/arrow.png" alt="">
						</div>
						<div class="single-work-process">
							...
							<h4 class="caption">Book an Appointment </h4>for service/repair
						</div>											
					<!--<div class="row">
						<div class="col"></div>
					</div>-->
			...
			<!--<section class="faq-area section-gap">
				<div class="container">
					...
					<div class="row faq-contents justify-content-center align-items-center">
						<div class="col-lg-12 text-center">
							<img src="img/faq.png" width="800" height="500" alt="">
						</div>						
					</div>
				</div>	
			</section>-->
