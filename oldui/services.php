	<!DOCTYPE html>
	<?php $title='Services'; include('header.php'); ?>	
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="services.php"> <?php echo $title; ?></a></p>
						</div>	
					</div>
				</div>
			</section>
