        ...
        <div class="m-auto col-lg-10 pad-0">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="alert border-dark alert-light" role="alert">
                          <h5 class="text-muted flashtxt mb-3"><b>Account Type:</b> Super Admin</h5>
                          <h5 class="mb-3 flashtxt"><b>Email:</b> <?php echo $_SESSION['email']; ?></h5>
                          <a class="btn btn-block btn-outline-dark" href="users/index.php">Goto Profile</a>
                        </div>
                    </div>
                <?php } } ?>
                </div>
