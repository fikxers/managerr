...
<body>
    ...
    <div class="outer-scontainer">
        ...
        <table id='userTable'>
            <thead>
              <tr>
                <th>Title</th><th>Full Name</th><th>Companions</th><th>Desinated Table</th>
              </tr>
            </thead>
            <tbody>
              <tr><td>HRH</td><td>Jacob Okhaishe</td><td>1</td><td>High Table</td></tr>
              <tr><td>Comrade</td><td>Ayuba Jatau</td><td>2</td><td>High Table</td></tr>
            </tbody>
        </table>
    </div>
