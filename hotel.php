<?php $title='Hotel Management'; include('header.php'); ?>
			    ...
			    <div class="main-menu">
					...
					<div class="fullscreen d-flex align-items-center wall-paper">
						<div class="banner-content col-lg-8 col-md-6 justify-content-center ">
							...
							<!-- <a href="signup.php"><button class="primary-btn add-btn btn btn-green">View Hotels</button></a> -->
						</div>	
