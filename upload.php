...
if(isset($_POST['submit'])){ 
  ...
  $query = "INSERT into `orders` (flat,estate,order_name,order_status, created_at, description,preferred_date, order_type,image_code) VALUES ('".$_SESSION['email']."', '".$_SESSION['estate']."','$equipment', 'pending','$trn_date', '$description','$date','repairs','".$image_code."')";
    ...
    if(!empty($fileNames)){ 
        ...
        if(!empty($insertValuesSQL)){ 
            ...
            if($insert){ 
                ...
                if($result){
				  echo "<script>alert('Handyman service request sent.');</script>";
